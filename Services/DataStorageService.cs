namespace GitMC.Services
{
    ...
    public class DataStorageService : IDataStorageService
    {
        ...
        public string GetManagedSavesDirectory() => Path.Combine(_dataDirectory, "saves");

        public string GetConfigurationFilePath() => Path.Combine(_dataDirectory, "config.json");
        ...
        public string GetCacheDirectory() => Path.Combine(_dataDirectory, "cache");
...
";
                ...
                catch (Exception ex)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"Failed to create data directories: {ex.Message}");
                }
