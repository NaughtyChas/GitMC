namespace GitMC.Models
{
    ...
    public class ManagedSaveInfo
    {
        ...
        // Computed properties
        public string SizeFormatted => Utils.CommonHelpers.FormatFileSize(Size);
        public string LastModifiedFormatted => Utils.CommonHelpers.FormatRelativeTime(LastModified);
    }
}
