    ...
    public abstract class Chunk
    {
        ...
        public virtual void Load(BinaryReader reader, bool raw = false)
        {
            ...
            try
            {
                ...
                byte[] compressedData = reader.ReadBytes((int)(dataLength - 1)); // -1 because compression type occupies 1 byte
        ...
        public virtual int Save(BinaryWriter writer)
        {
            ...
            try
            {
                ...
                if (IsOversized)
                {
                    compressionTypeByte = CompressionHelper.SetOversizedFlag(CompressionType);
                }
